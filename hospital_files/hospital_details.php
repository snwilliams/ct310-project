<div>
    <form method="GET">
        <input type="number" id="mpn" minlength="6" maxlength="6" name="searchquery" placeholder="Input your 6 digit MPN"><label>Please enter the MPN you would like additional information on, then press Enter.</label>
    </form>
    <div>
        <?php
